...
<body class="body-home-page">
      ...
      <nav>
        <div class="row">
          ...
          <ul class="main-nav">
              ...
              <li><a href="#schedule">Manage</a></li>
          </ul>
    ...
    <section class="home-page-section">
      <div class="row">
        <h2 class="home-content">Choose Preferred Shift</h2>

        <div class="shifts">
          <h3 class="header3-profilePage">Available Shifts</h3>
        </div>
          <!-- <p id="available-shift"><?php echo $employee['Email']; ?></p> -->

          <input type="checkbox" id="weekend-available-shift" name="weekendshifts" value="weekend">
          <label for="weekend-available-shift">Weekend Shifts</label>
          <input type="checkbox" id="weeks-available-shift" name="weeksshifts" value="weeks">
          <label for="weeks-available-shift">Weeks Shifts</label>
